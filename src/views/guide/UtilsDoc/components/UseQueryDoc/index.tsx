...
const demoHeader = {
    title: 'useQuery',
    desc: 'useQuery created on top of <a class="text-primary underline" href="https://reactrouter.com/docs/en/v6/hooks/use-location" target="_blank"><code>useLocation</code></a> hook to parse the query string.',
}
